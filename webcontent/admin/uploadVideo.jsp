										...
										<div class="row">
											<div class="form-email">
												...
												<p><s:select name="standard"
													cssClass="form-control col-md-8 select" id="standard"
													list="#{'3':'Three','4':'Four','5':'Five', '6':'Six', '7':'Seven', '8':'Eight', '9':'Nine', '10':'Ten', '11':'Eleven', '12':'Twelve'}"
											...
											<div class="form-email">
												...
												<p><s:select name="subject"
													cssClass="form-control col-md-8 select" id="subject"
													list="#{'Maths':'Maths','Physics':'Physics','Chemistry':'Chemistry', 'Natural Sciences':'Natural Sciences', 'Social':'Social', 'English':'English', 'GK':'GK', 'Inspiration':'Inspiration'}"
													headerKey="" headerValue="Select Subject">
												</s:select>
												<!-- <s:fielderror fieldName="subject" /><s:actionerror /> -->
												</p>
											</div>
											<div class="form-email">
												<label class="col-md-4">Title</label>
												<p><s:textfield name="title" cssClass="form-control col-md-8"
													type="text" placeholder="Tilte Here" id="title"></s:textfield>
												<!-- <s:fielderror fieldName="title" /><s:actionerror /> -->
												</p>
											</div>
											<div class="form-email">
												<label class="col-md-4">Description</label>
												<p><s:textarea name="description" cssClass="form-control col-md-8"
											...
											<div class="form-email">
												...
												<p><s:textfield name="url" cssClass="form-control col-md-8"
