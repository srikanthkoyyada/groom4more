...
<body>
	<div id="main" class="wrap">
		...
		<section class="page-top wrap">
			...
			<h2 class="page-section-title">Video Upload</h2>
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<article class="single-blog-post">
							<h3 style="color: #393939;">Video uploaded succesfully!!</h3>
							<a class="btn btn-block btn-info btn-lg" href="<%=request.getContextPath() %>/admin/uploadVideo.jsp">UPLOAD MORE</a>
						</article>
					</div>
				</div>
			</div>
