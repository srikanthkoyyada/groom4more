			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-7 col-md-8">
						...
						<div class="row">
							<%
							if(request.getParameter("subject")!=null && Integer.parseInt(request.getParameter("standard"))!=0) {AdminDAO dao = new AdminDAOImpl();
							...
							<div class="blog-button">
								<a href="<%=request.getContextPath()%>/admin/video.jsp?id=<%=bean.getId() %>" class="btn-color">See Video</a>
							</div>
							<hr>
							<% } }%>
							</div>
