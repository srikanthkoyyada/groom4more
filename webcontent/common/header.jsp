					...
					<nav class="navbar navbar-custom" role="navigation">
						...
						<div class="collapse navbar-collapse" id="collapse-navigation">
							<ul class="nav menu-nav">
								...
								<li id="mocks"><a href="<%=request.getContextPath() %>/mocks">MOCKS</a></li>
						              ...
						              <li class="dropdown-submenu">
						               <a tabindex="-1" href="#">SCHOOL</a>
						                <ul class="dropdown-menu">
											...
											<li><a href="<%=request.getContextPath() %>/jsp/tests/iit-test.jsp">IIT FOUNDATION</a></li>
											<li><a href="<%=request.getContextPath() %>/jsp/tests/olympiad-test.jsp">OLYMPIAD</a></li>
											<li><a href="<%=request.getContextPath() %>/jsp/tests/cbse.jsp">CBSE</a></li>
											<li><a href="<%=request.getContextPath() %>/jsp/tests/ssc.jsp">SSC</a></li>
										</ul>
						             </li>
						              <!-- <li class="divider"></li> -->						              
						              <li class="dropdown-submenu">
						               <a tabindex="-1" href="#">ENTRANCE EXAM</a>    
						              
						                <ul class="dropdown-menu">
						                  <li><a tabindex="-1" href="#"></a></li>
						                  <li><a href="<%=request.getContextPath() %>/jsp/tests/inter.jsp">CHAPTER WISE</a></li>
						                  <li><a href="<%=request.getContextPath() %>/jsp/tests/tests.jsp?type=EAMCET">EAMCET</a></li>
						                  <li><a href="<%=request.getContextPath() %>/jsp/tests/tests.jsp?type=IIT">IIT</a></li>
						                  <li><a href="<%=request.getContextPath() %>/jsp/tests/tests.jsp?type=VITEEE">VIT EEE</a></li>
						                   <li><a href="<%=request.getContextPath() %>/jsp/tests/tests.jsp?type=BITSAT">BITSAT</a></li>
						                    <li><a href="<%=request.getContextPath() %>/jsp/tests/tests.jsp?type=SRMEEE">SRMEEE</a></li>
						                     <li><a href="<%=request.getContextPath() %>/jsp/tests/tests.jsp?type=MIT">MIT</a></li>
						                </ul>
						              </li>						              
						            </ul>
						        </li>
