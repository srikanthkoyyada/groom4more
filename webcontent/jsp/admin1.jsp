							...
							<div class="row">
								<div class="col-md-3">
									...
									<!-- <s:select name="subject" id="topic-subject" cssClass="form-control input-md"
										tabindex="1" list="#{'Maths':'Maths', 'Science':'Science', 'Social':'Social', 'IIT Foundation':'IIT Foundation', 'Olympiad':'Olympiad', 'grand':'Grand Test', 'EAMCET':'EAMCET', 'engg':'Engineering'}" headerKey="" headerValue="Select Subject"></s:select> -->
									<s:select name="subject" id="topic-subject" cssClass="form-control input-md"
