        ...
        <div class="container">
            ...
            <nav class="navigation col-md-10">
                ...
                <ul class="menu">
                    ...
                    <ul class="sub-menu">
                            <li style="list-style: none;"><a href="<%=request.getContextPath() %>/jsp/olympiad-test.jsp">Olympiad</a></li>
                            <li style="list-style: none;"><a href="<%=request.getContextPath() %>/jsp/iit-test.jsp">IIT Foundation</a></li>
                            <li style="list-style: none;"><a href="<%=request.getContextPath() %>/jsp/eamcet.jsp">Eamcet</a></li>
                        </ul>
                    </li>
                    ...
                    <c:if test="${sessionScope.user==null}">
						...
						<c:choose>
							...
							<c:otherwise>
								<li id="login" style="background-color: #76DE7A;"><a href="<%=request.getContextPath() %>/jsp/login.jsp">Login</a></li>
							</c:otherwise>
						</c:choose>
	                </ul>
