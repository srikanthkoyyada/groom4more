						...
						<article class="single-blog-post">
							...
							<div class="clearfix margin-b32">
								...
								<div class="blog-title">
									<h4>PRODIGIES - First Round Submission</h4>
							...
							<s:form action="prodigy_submission" method="post"
								...
								<fieldset class="col-md-12 registration-form">
									...
									<p><s:textfield name="teamname" cssClass="comm-field col-md-8 col-xs-12"
									...
									<p><s:textfield name="schoolname" cssClass="comm-field col-md-8 col-xs-12"
