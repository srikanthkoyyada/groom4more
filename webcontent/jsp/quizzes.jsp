...
<body id="page-top" class="home">
	...
	<section id="questions" class="questions" style="min-height: 520px;">
		<div class="container">
			<div class="row">
				<!-- Tests LIST -->
				<div class="col-md-10 col-md-offset-1" style="align: center;">
					<div class="col-md-4">
					<div class="pricel">
						<h5 class="phead-top tabred">Mathematics</h5>
						<div class="phead-bottom" align="center">
						<img src="<%=request.getContextPath()%>/images/111.jpg" alt=""
							style="height: 100px; width: 100px;" />
						</div>
						<div class="plist">	
					<p>Test your mathematics skills here. Every week,
						you will be able to participate in one maths test, get
						analysis and improve your performances. This is the start of
						something amazing in your IIT preparation Journey.</p></div>
					<div class="pbutton button">
						<s:form action="start-test" method="post" align="center"
								theme="simple">
							<s:hidden name="category" value="maths"></s:hidden>
							<s:submit cssClass="mc-btn btn-style-1" style="background: #ff5d5e; color: #FFF;" value="PROCEED"></s:submit>
						</s:form>
					</div>
				</div>
				</div>
				<div class="col-md-4">
					...
					<div class="pbutton button">
						<s:form action="start-test" method="post" align="center"
							...
							<s:submit cssClass="mc-btn btn-style-1" style="background: #08c; color: #FFF;" value="PROCEED"></s:submit>
						</s:form>
					</div>
				</div>
				</div>
					...
					<div class="pricel">
						...
						<div class="phead-bottom" align="center">
							<img src="<%=request.getContextPath()%>/images/ch.jpg" alt=""
								style="height: 100px; width: 100px;" />
						</div>
						<div class="plist">
							<p>Take the weekly Chemistry tests and perfect one topic
								at a time. Now that you are doing amazingly well in Maths
								and Physics, would you not want to do well in Chemistry as
								well ? </p><br>
						</div>
						<div class="pbutton button">
							<s:form action="start-test" method="post" align="center"
								...
								<s:submit cssClass="mc-btn btn-style-1" style="background: #5ED960; color: #FFF;" value="PROCEED"></s:submit>
							</s:form>
						</div>
					</div>
				</div>
