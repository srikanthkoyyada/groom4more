...
<%
	if(request.getParameter("reftxt")!=null) {
		String refText=request.getParameter("reftxt").toString();
	}
%>
<!DOCTYPE html>
								...
								<fieldset class="col-md-12 registration-form">
									...
									<div class="row">
									 ...
									 <label class="col-md-4">City</label>
										...
										<%	if(request.getParameter("reftxt")!=null) { %>
											<input type="hidden" name="refText" value="<%=request.getParameter("reftxt") %>">
										<%	} %>
										<label class="col-md-4">Standard</label>
										<p><s:select name="standard"
											cssClass="comm-field col-md-8 select" id="standard"
											list="#{'3':'Third', '4':'Fourth', '5':'Fifth', '6':'Sixth','7':'Seventh','8':'Eight','9':'Ninth', '10':'Tenth', '11':'Eleventh', '12':'Twelfth'}"
