			...
			<div class="container">
				<div class="question-content-wrap">
					<div class="row">
						...
						<s:else>
						<div class="col-md-12">
							<h5>No questions found under this topic..!Please come back again </h5>
								<br>
								...
								<input type="hidden" name="standard" id="standard" value="11" />
								<s:hidden name="division" value="1"></s:hidden>

								<s:submit cssClass="btn btn-success col-md-6 col-md-offset-3" 
									value="Go back to test list"></s:submit>
							</s:form>
							<br><br>
							</div>
						</s:else>
