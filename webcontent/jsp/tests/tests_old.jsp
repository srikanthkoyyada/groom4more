				...
				<div class="row">
					<div class="col-sm-7 col-md-8">
						<article class="single-blog-post">
							<%
								if(request.getParameter("type").toString().equalsIgnoreCase("EAMCET")) {
							%>	
							...
							<ol>
 							...
 							<h5>C. Question paper format and Marking scheme:</h5>
 							<ol>
						...
						<div class="home-feature">
								...
								<s:form action="start-test-category" method="get" align="center"
									...
									<% 
										...
										if(miscDAO.isUserSubscribed(user.getUsername(), request.getParameter("type"))) {
									%>
