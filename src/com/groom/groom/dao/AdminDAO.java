...
public abstract interface AdminDAO
{
  ...
  public abstract List<Video> getAllVideosBySubject(String paramString)
    throws SQLException;
  
  public abstract List<Video> getAllVideosByStandard(int paramInt)
    throws SQLException;
  
  public abstract List<Video> getAllVideosByStandardAndSubject(int paramInt, String paramString)
    throws SQLException;
  
  public abstract Integer getNoofQuestions(String paramString, int paramInt)
    throws SQLException;
...
/* Location:              D:\New folder\WEB-INF\classes\com\groom.zip!\groom\groom\dao\AdminDAO.class
