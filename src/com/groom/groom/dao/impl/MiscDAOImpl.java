...
/* 110 */     PreparedStatement updateps = null;
/* 111 */     int updcnt = 0;
/* 112 */     String date = null;
/*     */     try {
/* 114 */       conn = ds.getConnection();
/* 115 */       String selectQuery = "SELECT DATE_OF_LIKE FROM VALIDATE_LIKES WHERE USER_NAME=? AND ID=?";
/* 116 */       preparedStatement = conn.prepareStatement(selectQuery);
/* 117 */       preparedStatement.setString(1, votinguser);
/* 118 */       preparedStatement.setInt(2, id);
/* 119 */       ResultSet resultSet = preparedStatement.executeQuery();
/* 120 */       while (resultSet.next()) {
/* 121 */         date = resultSet.getDate(1).toString();
/* 122 */         System.out.println(resultSet.getDate(1).toString());
/* 123 */         System.out.println(GroomUtil.getCurrentDate().toString());
/*     */       }
/* 125 */       if (resultSet.getDate(1).toString() != GroomUtil.getCurrentDate().toString()) {
/* 126 */         String query = "UPDATE PRODIGIES SET NO_OF_VOTES=NO_OF_VOTES+1 WHERE ID=?";
/* 127 */         preparedStatement = conn.prepareStatement(query);
/* 128 */         preparedStatement.setInt(1, id);
/* 129 */         int status = 0;
/* 130 */         status = preparedStatement.executeUpdate();
/* 131 */         String query1 = "INSERT INTO VALIDATE_LIKES(USER_NAME, ID, DATE_OF_LIKE) VALUES(?,?,?)";
/* 132 */         preparedStatement = conn.prepareStatement(query1);
/* 133 */         preparedStatement.setString(1, votinguser);
/* 134 */         preparedStatement.setInt(2, id);
/* 135 */         preparedStatement.setDate(3, GroomUtil.getCurrentDate());
/* 136 */         updcnt = preparedStatement.executeUpdate();
/* 137 */         return true;
/*     */       }
/* 139 */       return false;
/*     */     }
...
/* 158 */       String query = "SELECT * FROM PRODIGIES WHERE ID=?";
/* 159 */       statement = connection.prepareStatement(query);
/* 160 */       statement.setInt(1, id);
/* 161 */       resultSet = statement.executeQuery();
/* 162 */       return resultSet.next();
...
/*     */   {
/* 174 */     Connection connection = ds.getConnection();
/* 175 */     PreparedStatement preparedStatement = null;
/* 176 */     ResultSet resultSet = null;
/*     */     try {
/* 178 */       String query = "SELECT * FROM EXAM_SUBSCRIPTION WHERE USER_NAME=? AND (" + type + "=1 OR ALLTESTS=1)";
/* 179 */       preparedStatement = connection.prepareStatement(query);
/* 180 */       preparedStatement.setString(1, username);
/*     */       
/*     */ 
/*     */ 
...
/*     */   {
/* 202 */     Connection connection = ds.getConnection();
/* 203 */     PreparedStatement preparedStatement = null;
/* 204 */     ResultSet resultSet = null;
/*     */     try {
/* 206 */       String query = "SELECT * FROM EXAM_SUBSCRIPTION WHERE USER_NAME=? AND " + type + "=1";
/* 207 */       preparedStatement = connection.prepareStatement(query);
/* 208 */       preparedStatement.setString(1, username);
/*     */       
/*     */ 
/*     */ 
...
/* Location:              D:\New folder\WEB-INF\classes\com\groom.zip!\groom\groom\dao\impl\MiscDAOImpl.class
