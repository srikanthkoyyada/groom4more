...
/*     */ @Action(value="enggquiz", results={@org.apache.struts2.convention.annotation.Result(name="success", location="/jsp/tests/enggquiz.jsp"), @org.apache.struts2.convention.annotation.Result(name="invalid.token", location="/index.jsp")})
/*     */ public class IITQuizQuestionsAction
...
/*     */   {
/*  42 */     setQuestionsList(this.quizService.getQuizDetails(getCategory(), Integer.parseInt(getTopicid())));
/*  43 */     setQuizSize(getQuestionsList().size());
/*  44 */     setTopicid(getTopicid());
...
/*  98 */     return this.division;
/*     */   }
/*     */   
/*     */   public void setDivision(int division) {
/* 102 */     this.division = division;
/*     */   }
/*     */ }


/* Location:              D:\New folder\WEB-INF\classes\com\groom.zip!\groom\groom\actions\IITQuizQuestionsAction.class
